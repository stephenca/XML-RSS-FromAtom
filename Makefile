# This Makefile is for the XML::RSS::FromAtom extension to perl.
#
...
#     ABSTRACT => q[create a XML::RSS object out of an Atom feed]
#     AUTHOR => [q[Stephen Cardie <stephenca@ls26.net>]]
#     BUILD_REQUIRES => { warnings=>q[0], File::Spec=>q[0], Data::Dumper=>q[0], Test::More=>q[0], strict=>q[0], File::Find=>q[0], File::Temp=>q[0], Test::Most=>q[0], File::Slurp=>q[0] }
#     CONFIGURE_REQUIRES => { ExtUtils::MakeMaker=>q[6.30] }
#     DISTNAME => q[XML-RSS-FromAtom]
#     EXE_FILES => []
#     LICENSE => q[perl]
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/XML/RSS/FromAtom.pm
...
TO_INST_PM = lib/XML/RSS/FromAtom.pm

PM_TO_BLIB = lib/XML/RSS/FromAtom.pm \
...
DISTVNAME = XML-RSS-FromAtom-0.02_01
...
manifypods : pure_all  \
	lib/XML/RSS/FromAtom.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/XML/RSS/FromAtom.pm $(INST_MAN3DIR)/XML::RSS::FromAtom.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''create a XML::RSS object out of an Atom feed'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: XML-RSS-FromAtom' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '  DateTime::Format::Mail: 0' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'version: 0.02_01' >> META_new.yml
	-$(NOECHO) $(MV) META_new.yml $(DISTVNAME)/META.yml
	$(NOECHO) $(ECHO) Generating META.json
	$(NOECHO) $(ECHO) '{' > META_new.json
	$(NOECHO) $(ECHO) '   "abstract" : "create a XML::RSS object out of an Atom feed",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "XML-RSS-FromAtom",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '            "DateTime::Format::ISO8601" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "DateTime::Format::Mail" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Moo" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Try::Tiny" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "XML::Atom::Syndication::Feed" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "XML::RSS" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "common::sense" : "0"' >> META_new.json
	$(NOECHO) $(ECHO) '         }' >> META_new.json
	$(NOECHO) $(ECHO) '      }' >> META_new.json
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "release_status" : "testing",' >> META_new.json
	$(NOECHO) $(ECHO) '   "version" : "0.02_01"' >> META_new.json
	$(NOECHO) $(ECHO) '}' >> META_new.json
...
TEST_FILE = test.pl
TEST_FILES = t/*.t t/lib/xml/rss/*.t
TESTDB_SW = -d
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>create a XML::RSS object out of an Atom feed</ABSTRACT>' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="XML::Atom::Syndication::Feed" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/XML/RSS/FromAtom.pm blib/lib/XML/RSS/FromAtom.pm 
